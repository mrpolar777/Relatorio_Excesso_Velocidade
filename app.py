...
if gerar:
    try:
        ...
        for v in veiculos:
            ...
            mapa_html_path = os.path.join(temp_dir, f"mapa_{placa}.html")
            ...
            with st.expander(f"Visualizar rota: {placa}"):
                html(open(mapa_html_path, 'r').read(), height=500)
